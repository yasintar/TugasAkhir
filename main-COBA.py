...
class Main:
    ...
    def start(self):
        ...
        #schedule.every(2).minutes.do(self.adaptSch)
...
#        schedule.every(1).minutes.until(timedelta(seconds=20)).do(self.adaptRAMRules)      
...
#        self.adaptRules()        
#             
#        if not self.scheduling and self.ags._cpu < CONST_CPU and self.ags._ram < CONST_RAM and self.ags._disk < CONST_DISK:
#            print(">>> Resume Scheduling..... <<<<")
#            self.scheduling = True
